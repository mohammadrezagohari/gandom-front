                    ...
                    <div className="w-full flex-col">
                        ...
                        <div className="w-full py-5 mt-5">
                            ...
                            <p className="font-light font-Poppins rtl:font-yekanBakh text-justify md:text-start text-dark dark:text-white text-base md:text-xl w-12/12 md:w-11/12 ">
                                Gandom is a software group consisting of capable and talented young
                                Iranians who are active Gandom is a software group consisting of
                                capable and talented young Iranians who are active in the fields of
                                production and design of websites and web-based software, as well as
